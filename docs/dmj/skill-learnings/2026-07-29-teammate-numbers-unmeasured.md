...
- **What happened:** four confidently stated estimates were published or endorsed and every one was wrong: a ~150-word trim recovered 26 (5x optimism), a 4-of-11 exemption count was 1 clear plus 1 marginal, a 4-of-6 sibling count was 5-of-6, and one wrong figure reached the CHANGELOG draft before being caught. Every correction came from a peer measuring, never from the author, and never from reasoning about the claim.
- **What should have happened:** the lead treats any number in a teammate report as a hypothesis and adopts it only with the measurement, or the producing command, attached.
