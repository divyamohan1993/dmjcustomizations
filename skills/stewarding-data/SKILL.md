...
description: Use when creating or changing a schema, writing or running a migration, handling backups or restores, bulk-editing production data, storing PII, or setting retention and deletion policy. Symptoms: ALTER or DROP on a live table, "just run this SQL on prod", a backup that has never been restored, a right-to-deletion request, a backfill over a big table.
---
