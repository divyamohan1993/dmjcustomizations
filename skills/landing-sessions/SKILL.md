...
1. **Memory write-back.** Every non-obvious learning, decision, or gotcha: memory file + one MEMORY.md index line. Never repo-derivable facts; update or delete stale entries while there.
